...
keys = [
    ...
    Key([mod], "y", lazy.hide_show_bar("bottom"), desc="Toggle bar",),
    ...
    Key([mod], "period", lazy.spawn('/home/tim/dotfiles/.config/rofi/scripts/scripts.sh'), desc="rofi script selector",),
